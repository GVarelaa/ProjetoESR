...
class Message:
    def __init__(self, msg_type, flag=0, timestamp=0, source_ip="", hops=list(), neighbours=list(), contents=list(), servers=list()):
        # Header
        self.type = msg_type
        self.flag = flag
    ...
    def __str__(self):
        return f"Type: {self.type} | Flag: {self.flag} | Timestamp: {self.timestamp} | Source IP: {self.source_ip} | Hops: {self.hops} | Servers: {self.servers} | Neighbours: {self.neighbours} | Contents: {self.contents}"
    ...
    def deserialize(bytes):
        ...
        return Message(msg_type, flag=flags, timestamp=timestamp, source_ip=source_ip, hops=hops, servers=servers, neighbours=neighbours, contents=contents)
